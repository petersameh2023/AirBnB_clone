...
class TestPlace(unittest.TestCase):
    ...
    def test_place_description_setter(self):
        """Test setting the description attribute."""
        place = Place()
        place.description = "A charming apartment in the heart of the city."
        self.assertEqual(place.description, "A charming apartment in the heart of the city.")

    def test_place_number_rooms_setter(self):
        """Test setting the number_rooms attribute."""
        place = Place()
        place.number_rooms = 2
        self.assertEqual(place.number_rooms, 2)

    def test_place_number_bathrooms_setter(self):
        """Test setting the number_bathrooms attribute."""
        place = Place()
    ...
    def test_place_amenity_ids_setter(self):
        ...
        place = Place()
        place.amenity_ids = ["12345678-90ab-cdef-ghij-klmnopqrst",
                             "98765432-10fe-dcba-9876-543210fedcba"]
        self.assertEqual(place.amenity_ids, ["12345678-90ab-cdef-ghij-klmnopqrst",
                                             "98765432-10fe-dcba-9876-543210fedcba"])
    ...
    def test_place_to_dict(self):
        ...
        place.description = "A beautiful house with a stunning ocean view."
        place.number_rooms = 3
        place.number_bathrooms = 2
        place.max_guest = 6
        place.price_by_night = 200
        place.latitude = 34.0522
        place.longitude = -118.2437
        place.amenity_ids = ["12345678-90ab-cdef-ghij-klmnopqrst",
                             "98765432-10fe-dcba-9876-543210fedcba"]
        place_dict = place.to_dict()
        self.assertEqual(place_dict["__class__"], "Place")
        self.assertEqual(place_dict["city_id"], "12345678-90ab-cdef-ghij-klmnopqrst")
        self.assertEqual(place_dict["user_id"], "98765432-10fe-dcba-9876-543210fedcba")
        self.assertEqual(place_dict["name"], "Beach House")
        self.assertEqual(place_dict["description"], "A beautiful house with a stunning ocean view.")
        ...
        self.assertEqual(place_dict["amenity_ids"], ["12345678-90ab-cdef-ghij-klmnopqrst",
                                                     "98765432-10fe-dcba-9876-543210fedcba"])
    ...
    def test_place_str_representation(self):
        ...
        self.assertIn("'city_id': '12345678-90ab-cdef-ghij-klmnopqrst'", place_str)
        self.assertIn("'user_id': '98765432-10fe-dcba-9876-543210fedcba'", place_str)
    ...
    def test_place_create_from_dict(self):
        ...
        place_dict = {
            ...
            'latitude': 40.7128,
            'longitude': -74.0060,
            'amenity_ids': ['12345678-90ab-cdef-ghij-klmnopqrst',
                             '98765432-10fe-dcba-9876-543210fedcba']
        }
        ...
        self.assertEqual(place.description, 'A spacious villa with a private pool.')
